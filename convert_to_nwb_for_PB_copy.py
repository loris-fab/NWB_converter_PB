...
def convert_data_to_nwb_PB(input_folder, output_folder, choice_mouses = None):
    ...
    # Reload the module (in case of live edits during development)
    ...
    failures = []  # List of failures: (cell_id, error_message)
    ...
    for cell_id in choice_cells:
        try:
            ...
            # Create the initial NWB file (metadata + structure)
            ...
            # ⚙️ Add behavior-related data (movements, responses, etc.)
